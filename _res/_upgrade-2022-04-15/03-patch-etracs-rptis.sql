...
/* CHANGE RPUT TYPE  */
alter table faas_txntype add allowannotated int default 0
;
...
INSERT IGNORE INTO `sys_var` (`name`, `value`, `description`, `datatype`, `category`) VALUES ('fileserver_download_task_active', '1', 'Activate / Deactivate download task', 'boolean', 'SYSTEM');
INSERT IGNORE INTO `sys_var` (`name`, `value`, `description`, `datatype`, `category`) VALUES ('fileserver_upload_task_active', '1', 'Activate / Deactivate upload task', 'boolean', 'SYSTEM');
